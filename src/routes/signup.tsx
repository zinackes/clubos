  ...
  return (
    <>
        <div className={"min-h-screen flex flex-col"}>
            <Navbar01></Navbar01>
            <div className={"w-full h-full flex-1 grid grid-cols-2 grid-rows-1 font-base"}>
                    ...
                    <div className={"relative z-10 flex flex-col justify-between md:p-12 lg:p-14 xl:p-16 w-full text-white h-full"}>
                        <div className={"space-y-8 my-auto"}>
                            <div className={"space-y-4"}>
                                <h2 className={" lg:text-3xl font-bold leading-tight tracking-light"}>
                            ...
                            <div className={"pt-8 border-t border-white/10"}>
                                <div className={"flex items-center gap-4"}>
                                    <div className="*:data-[slot=avatar]:ring-background flex -space-x-2 *:data-[slot=avatar]:ring-1 *:data-[slot=avatar]:ring-indigo-900 ">
                                        <Avatar>
